...
def ToLoadDataOntoFile(Datatoload):
    ...
    for Inst in ListOfAllInst:
        ...
        for instDetails in EachInst:
            ...
            counter = counter + 1
            record = ec2DataWithCosting(ec_id, ec2_amiid, ec2_type, ec2_state, ec2_domain, ec2_env, ec2_name,
...
if __name__ == '__main__':
    ...
    print "Creation table ec2_static_data"
    if engine.dialect.has_table(engine, ec2DataWithCosting.__tablename__):
